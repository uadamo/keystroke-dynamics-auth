...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2a-single-rf')
    ...
    ws_stats = wb.add_sheet('task2a-statistical-rf')
    ...
    ws_non_temp = wb.add_sheet('task2a-non-temporal-rf')
    ...
    ws_all = wb.add_sheet('task2a-all-rf')
    ...
    wb.save("task2a_rf_no_selection.xls")  
...
def xlReportRecursiveCVSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2a-single-rf-recursive-CV')
    ...
    wb.save("task2a_rf_recursive-CV.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2a-rf-sequential')
    ...
    wb.save("task2a_rf_sequential.xls")  
