...
merged_DU_keyPreference_data_nopred = merged_DU_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_DU_keyPreference_data_pred= merged_DU_keyPreference_data['user']
...
merged_UD_keyPreference_data_nopred =  merged_UD_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_UD_keyPreference_data_pred= merged_UD_keyPreference_data['user']
...
merged_DU_keyPreference_data_nopred_train, merged_DU_keyPreference_data_nopred_test, merged_DU_keyPreference_data_pred_train, merged_DU_keyPreference_data_pred_test = train_test_split(merged_DU_keyPreference_data_nopred, merged_DU_keyPreference_data_pred, shuffle=True, test_size=0.4)
...
merged_UD_keyPreference_data_nopred_train, merged_UD_keyPreference_data_nopred_test, merged_UD_keyPreference_data_pred_train, merged_UD_keyPreference_data_pred_test = train_test_split(merged_UD_keyPreference_data_nopred, merged_UD_keyPreference_data_pred, shuffle=True, test_size=0.4)
...
rf8.fit(merged_DU_keyPreference_data_nopred_train, merged_DU_keyPreference_data_pred_train)
...
rf11.fit(merged_UD_keyPreference_data_nopred_train, merged_UD_keyPreference_data_pred_train)
...
merged_DU_keyPreference_data_prediction = rf8.predict(merged_DU_keyPreference_data_nopred_test)
merged_DU_keyPreference_data_accuracy = accuracy_score(merged_DU_keyPreference_data_pred_test, merged_DU_keyPreference_data_prediction)
...
merged_UD_keyPreference_data_prediction = rf11.predict(merged_UD_keyPreference_data_nopred_test)
merged_UD_keyPreference_data_accuracy = accuracy_score(merged_UD_keyPreference_data_pred_test, merged_UD_keyPreference_data_prediction)
...
print("task 2b DU Accuracy:", DU_accuracy)
print("task 2b UU Accuracy:", UU_accuracy)
print("task 2b DD Accuracy:", DD_accuracy)
print("task 2b UD Accuracy:", UD_accuracy)
print("task 2b trigraph Accuracy:", trigraph_accuracy)

print("\n")

print("task 2b DU + typing accuracy Accuracy:", merged_DU_accuracy_data_accuracy)
print("task 2b DU + typing speed Accuracy:", merged_DU_speed_data_accuracy)
print("task 2b DU + key preference Accuracy:", merged_DU_keyPreference_data_accuracy)
print("task 2b DU + reaction time Accuracy:", merged_DU_reaction_data_accuracy)

print("\n")

print("task 2b UD + typing accuracy Accuracy:", merged_UD_accuracy_data_accuracy)
print("task 2b UD + typing speed Accuracy:", merged_UD_speed_data_accuracy)
print("task 2b UD + key preference Accuracy:", merged_UD_keyPreference_data_accuracy)
print("task 2b UD + reaction time Accuracy:", merged_UD_reaction_data_accuracy)