...
merged_DU_keyPreference_data_X = merged_DU_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_DU_keyPreference_data_y= merged_DU_keyPreference_data['user']
...
merged_UD_keyPreference_data_X =  merged_UD_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_UD_keyPreference_data_y= merged_UD_keyPreference_data['user']
...
merged_UU_keyPreference_data_X =  merged_UU_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_UU_keyPreference_data_y= merged_UU_keyPreference_data['user']
...
merged_DD_keyPreference_data_X =  merged_DD_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_DD_keyPreference_data_y= merged_DD_keyPreference_data['user']
...
merged_DU_keyPreference_data_X_train, merged_DU_keyPreference_data_X_test, merged_DU_keyPreference_data_y_train, merged_DU_keyPreference_data_y_test = train_test_split(merged_DU_keyPreference_data_X, merged_DU_keyPreference_data_y, shuffle=True, test_size=0.4)
...
merged_UD_keyPreference_data_X_train, merged_UD_keyPreference_data_X_test, merged_UD_keyPreference_data_y_train, merged_UD_keyPreference_data_y_test = train_test_split(merged_UD_keyPreference_data_X, merged_UD_keyPreference_data_y, shuffle=True, test_size=0.4)
...
merged_UU_keyPreference_data_X_train, merged_UU_keyPreference_data_X_test, merged_UU_keyPreference_data_y_train, merged_UU_keyPreference_data_y_test = train_test_split(merged_UU_keyPreference_data_X, merged_UU_keyPreference_data_y, shuffle=True, test_size=0.4)
...
merged_DD_keyPreference_data_X_train, merged_DD_keyPreference_data_X_test, merged_DD_keyPreference_data_y_train, merged_DD_keyPreference_data_y_test = train_test_split(merged_DD_keyPreference_data_X, merged_DD_keyPreference_data_y, shuffle=True, test_size=0.4)
...
rf8.fit(merged_DU_keyPreference_data_X_train, merged_DU_keyPreference_data_y_train)
...
rf11.fit(merged_UD_keyPreference_data_X_train, merged_UD_keyPreference_data_y_train)
...
rf16.fit(merged_UU_keyPreference_data_X_train, merged_UU_keyPreference_data_y_train)
...
rf20.fit(merged_DD_keyPreference_data_X_train, merged_DD_keyPreference_data_y_train)
...
merged_DU_keyPreference_data_prediction = rf8.predict(merged_DU_keyPreference_data_X_test)
merged_DU_keyPreference_data_accuracy = accuracy_score(merged_DU_keyPreference_data_y_test, merged_DU_keyPreference_data_prediction)
...
merged_UD_keyPreference_data_prediction = rf11.predict(merged_UD_keyPreference_data_X_test)
merged_UD_keyPreference_data_accuracy = accuracy_score(merged_UD_keyPreference_data_y_test, merged_UD_keyPreference_data_prediction)
...
merged_UU_keyPreference_data_prediction = rf16.predict(merged_UU_keyPreference_data_X_test)
merged_UU_keyPreference_data_accuracy = accuracy_score(merged_UU_keyPreference_data_y_test, merged_UU_keyPreference_data_prediction)
...
merged_DD_keyPreference_data_prediction = rf20.predict(merged_DD_keyPreference_data_X_test)
merged_DD_keyPreference_data_accuracy = accuracy_score(merged_DD_keyPreference_data_y_test, merged_DD_keyPreference_data_prediction)
...
def accuracyReport(mainFeatureName, mainFeatureAccuracy, mergedAccuracy, mergedSpeed, mergedKeyPreference, mergedReaction):
    ...
    for key, value in mergedMap.items():
        if(value - mainFeatureAccuracy >= 0.8):
            print(f"{mainFeatureName} merged with {key} accuracy: {value} STRONGLY IMPROVED original")
        elif(value - mainFeatureAccuracy < 0.8 and value - mainFeatureAccuracy > 0.04 and value > mainFeatureAccuracy):
