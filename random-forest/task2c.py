...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2c-single-rf')
    ...
    ws_stats = wb.add_sheet('task2c-statistical-rf')
    ...
    ws_non_temp = wb.add_sheet('task2c-non-temporal-rf')
    ...
    ws_all = wb.add_sheet('task2c-all-rf')
    ...
    wb.save("task2c_rf_no_selection.xls")  
...
def xlReportRecursiveCVSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2c-single-rf-recursive-CV')
    ...
    wb.save("task2c_rf_recursive-CV.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2c-rf-sequential')
    ...
    wb.save("task2c_rf_sequential.xls")  
