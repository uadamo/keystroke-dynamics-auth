...
import graphviz
from helpersSVM import featureAnalysis, featureAnalysisRecursiveCV, featureAnalysisSequentialSelector
...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2a-single-svm')
    ...
    ws_stats = wb.add_sheet('task2a-statistical-svm')
    ...
    ws_non_temp = wb.add_sheet('task2a-non-temporal-svm')
    ...
    ws_all = wb.add_sheet('task2a-all-svm')
    ...
    wb.save("task2a_svm_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2a-svm-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 30)]
    ...
    wb.save("task2a_svm_sequential.xls")  
...
def xlReportRecursiveCVSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2a-svm-recursive-CV')
    ...
    wb.save("task2a_svm_recursive-CV.xls")  
