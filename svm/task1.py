...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task1-single-svm')
    ...
    ws_stats = wb.add_sheet('task1-statistical-svm')
    ...
    ws_non_temp = wb.add_sheet('task1-non-temporal-svm')
    ...
    ws_all = wb.add_sheet('task1-all-svm')
    ...
    wb.save("task1_svm_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task1-svm-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 10), featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 12), featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 15), featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 18)]
    ...
    wb.save("task1_svm_sequential.xls")  
...
def xlReportRecursiveCVSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task1-svm-recursive-CV')
    ...
    feat = [featureAnalysisRecursiveCV(DD_non_temporal_and_statistic_data)]
    ...
    wb.save("task1_svm_recursive-CV.xls")  
