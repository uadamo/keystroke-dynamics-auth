...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2b-single-svm')
    ...
    ws_stats = wb.add_sheet('task2b-statistical-svm')
    ...
    ws_non_temp = wb.add_sheet('task2b-non-temporal-svm')
    ...
    ws_all = wb.add_sheet('task2b-all-svm')
    ...
    wb.save("task2b_svm_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2b-svm-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 20)]
    ...
    wb.save("task2b_svm_sequential.xls")  
...
def xlReportRecursiveCVSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2b-svm-recursive-CV')
    ...
    wb.save("task2b_svm_recursive-CV.xls")  
