...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2c-single-knn')
    ...
    ws_stats = wb.add_sheet('task2c-statistical-knn')
    ...
    ws_non_temp = wb.add_sheet('task2c-non-temporal-knn')
    ...
    ws_all = wb.add_sheet('task2c-all-knn')
