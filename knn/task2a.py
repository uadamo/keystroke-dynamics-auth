...
digraph_data = pd.read_csv('./csv_files/digraph_task2a.csv')
trigraph_data = pd.read_csv('./csv_files/trigraph_task2a.csv')

DU_data_statistical = pd.read_csv('./csv_files/DU_statistical_task2a.csv')
DD_data_statistical = pd.read_csv('./csv_files/DD_statistical_task2a.csv')
UU_data_statistical = pd.read_csv('./csv_files/UU_statistical_task2a.csv')
UD_data_statistical = pd.read_csv('./csv_files/UD_statistical_task2a.csv')
digraph_data_statistical = pd.read_csv('./csv_files/digraph_statistical_task2a.csv')
trigraph_data_statistical = pd.read_csv('./csv_files/trigraph_statistical_task2a.csv')
...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2a-single-knn')
    ...
    ws_stats = wb.add_sheet('task2a-statistical-knn')
    ...
    ws_non_temp = wb.add_sheet('task2a-non-temporal-knn')
    ...
    ws_all = wb.add_sheet('task2a-all-knn')
    ...
    wb.save("task2a_knn_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2a-knn-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 15),featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 25), featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 30), featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 35)]
    ...
    wb.save("task2a_knn_sequential.xls")  
