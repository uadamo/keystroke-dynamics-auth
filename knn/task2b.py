...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2b-single-knn')
    ...
    ws_stats = wb.add_sheet('task2b-statistical-knn')
    ...
    ws_non_temp = wb.add_sheet('task2b-non-temporal-knn')
    ...
    ws_all = wb.add_sheet('task2b-all-knn')
    ...
    wb.save("task2b_knn_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2b-knn-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 15),featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 25), featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 30), featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 35)]
    ...
    wb.save("task2b_knn_sequential.xls")  
