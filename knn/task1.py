...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task1-single-knn')
    ...
    ws_stats = wb.add_sheet('task1-statistical-knn')
    ...
    ws_non_temp = wb.add_sheet('task1-non-temporal-knn')
    ...
    ws_all = wb.add_sheet('task1-all-knn')
    ...
    wb.save("task1_knn_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task1-knn-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 10), featureAnalysisSequentialSelector(DU_non_temporal_and_statistic_data, 15)]
    ...
    wb.save("task1_knn_sequential.xls")  
