...
merged_DU_keyPreference_data = pd.merge(DU_data, keyPreference_data,  
                   on=['user','session', "task", "iteration"],  
                   how='inner') 
...
merged_UD_keyPreference_data = pd.merge(UD_data, keyPreference_data,  
                   on=['user','session', "task", "iteration"],  
                   how='inner') 
...
merged_UU_keyPreference_data = pd.merge(UU_data, keyPreference_data,  
                   on=['user','session', "task", "iteration"],  
                   how='inner') 
...
merged_DD_keyPreference_data = pd.merge(DD_data, keyPreference_data,  
                   on=['user','session', "task", "iteration"],  
                   how='inner') 
...
merged_DU_keyPreference_X = merged_DU_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_DU_keyPreference_y= merged_DU_keyPreference_data['user']

merged_DU_keyPreference_X_train, merged_DU_keyPreference_X_test, merged_DU_keyPreference_y_train, merged_DU_keyPreference_y_test = train_test_split(merged_DU_keyPreference_X, merged_DU_keyPreference_y, test_size = 0.4)

scaler_merged_DU_keyPreference = StandardScaler()
scaler_merged_DU_keyPreference.fit(merged_DU_keyPreference_X_train)
merged_DU_keyPreference_X_train = scaler_merged_DU_keyPreference.transform(merged_DU_keyPreference_X_train)
merged_DU_keyPreference_X_test = scaler_merged_DU_keyPreference.transform(merged_DU_keyPreference_X_test)


scores_merged_DU_keyPreference = {}
scores_merged_DU_keyPreference_list = []
for k in range(1,15):
   model = KNeighborsClassifier(n_neighbors=k)
   model.fit(merged_DU_keyPreference_X_train, merged_DU_keyPreference_y_train)
   merged_DU_keyPreference_y_pred = model.predict(merged_DU_keyPreference_X_test)
   scores_merged_DU_keyPreference[k] = metrics.accuracy_score(merged_DU_keyPreference_y_test,merged_DU_keyPreference_y_pred)
   scores_merged_DU_keyPreference_list.append(metrics.accuracy_score(merged_DU_keyPreference_y_test,merged_DU_keyPreference_y_pred))
result_merged_DU_keyPreference = metrics.confusion_matrix(merged_DU_keyPreference_y_test, merged_DU_keyPreference_y_pred)
# print("Confusion Matrix:")
# print(result_merged_DU_keyPreference)
result_merged_DU_keyPreference_1 = metrics.classification_report(merged_DU_keyPreference_y_test, merged_DU_keyPreference_y_pred)
# print("Classification Report:",)
# print (result_merged_DU_keyPreference_1)
...
selected_index_merged_DU_keyPreference = np.argmax(scores_merged_DU_keyPreference_list)
selected_k_merged_DU_keyPreference = range(1,30)[selected_index_merged_DU_keyPreference]

knn_merged_DU_keyPreference = KNeighborsClassifier(n_neighbors=selected_k_merged_DU_keyPreference)
knn_merged_DU_keyPreference.fit(merged_DU_keyPreference_X_train, merged_DU_keyPreference_y_train)
merged_DU_keyPreference_y_pred = knn_merged_DU_keyPreference.predict(merged_DU_keyPreference_X_test)

merged_DU_keyPreference_data_accuracy = accuracy_score(merged_DU_keyPreference_y_test, merged_DU_keyPreference_y_pred)
#precision = precision_score(merged_DU_keyPreference_y_test, merged_DU_keyPreference_y_pred, average="micro")
#recall = recall_score(merged_DU_keyPreference_y_test, merged_DU_keyPreference_y_pred, average="micro")
...
merged_UD_keyPreference_X = merged_UD_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_UD_keyPreference_y= merged_UD_keyPreference_data['user']

merged_UD_keyPreference_X_train, merged_UD_keyPreference_X_test, merged_UD_keyPreference_y_train, merged_UD_keyPreference_y_test = train_test_split(merged_UD_keyPreference_X, merged_UD_keyPreference_y, test_size = 0.4)

scaler_merged_UD_keyPreference = StandardScaler()
scaler_merged_UD_keyPreference.fit(merged_UD_keyPreference_X_train)
merged_UD_keyPreference_X_train = scaler_merged_UD_keyPreference.transform(merged_UD_keyPreference_X_train)
merged_UD_keyPreference_X_test = scaler_merged_UD_keyPreference.transform(merged_UD_keyPreference_X_test)


scores_merged_UD_keyPreference = {}
scores_merged_UD_keyPreference_list = []
for k in range(1,15):
   model = KNeighborsClassifier(n_neighbors=k)
   model.fit(merged_UD_keyPreference_X_train, merged_UD_keyPreference_y_train)
   merged_UD_keyPreference_y_pred = model.predict(merged_UD_keyPreference_X_test)
   scores_merged_UD_keyPreference[k] = metrics.accuracy_score(merged_UD_keyPreference_y_test,merged_UD_keyPreference_y_pred)
   scores_merged_UD_keyPreference_list.append(metrics.accuracy_score(merged_UD_keyPreference_y_test,merged_UD_keyPreference_y_pred))
result_merged_UD_keyPreference = metrics.confusion_matrix(merged_UD_keyPreference_y_test, merged_UD_keyPreference_y_pred)
# print("Confusion Matrix:")
# print(result_merged_UD_keyPreference)
result_merged_UD_keyPreference_1 = metrics.classification_report(merged_UD_keyPreference_y_test, merged_UD_keyPreference_y_pred)
# print("Classification Report:",)
# print (result_merged_UD_keyPreference_1)
...
selected_index_merged_UD_keyPreference = np.argmax(scores_merged_UD_keyPreference_list)
selected_k_merged_UD_keyPreference = range(1,30)[selected_index_merged_UD_keyPreference]

knn_merged_UD_keyPreference = KNeighborsClassifier(n_neighbors=selected_k_merged_UD_keyPreference)
knn_merged_UD_keyPreference.fit(merged_UD_keyPreference_X_train, merged_UD_keyPreference_y_train)
merged_UD_keyPreference_y_pred = knn_merged_UD_keyPreference.predict(merged_UD_keyPreference_X_test)

merged_UD_keyPreference_data_accuracy = accuracy_score(merged_UD_keyPreference_y_test, merged_UD_keyPreference_y_pred)
#precision = precision_score(merged_UD_keyPreference_y_test, merged_UD_keyPreference_y_pred, average="micro")
#recall = recall_score(merged_UD_keyPreference_y_test, merged_UD_keyPreference_y_pred, average="micro")
...
merged_DD_keyPreference_X = merged_DD_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_DD_keyPreference_y= merged_DD_keyPreference_data['user']

merged_DD_keyPreference_X_train, merged_DD_keyPreference_X_test, merged_DD_keyPreference_y_train, merged_DD_keyPreference_y_test = train_test_split(merged_DD_keyPreference_X, merged_DD_keyPreference_y, test_size = 0.4)

scaler_merged_DD_keyPreference = StandardScaler()
scaler_merged_DD_keyPreference.fit(merged_DD_keyPreference_X_train)
merged_DD_keyPreference_X_train = scaler_merged_DD_keyPreference.transform(merged_DD_keyPreference_X_train)
merged_DD_keyPreference_X_test = scaler_merged_DD_keyPreference.transform(merged_DD_keyPreference_X_test)


scores_merged_DD_keyPreference = {}
scores_merged_DD_keyPreference_list = []
for k in range(1,15):
   model = KNeighborsClassifier(n_neighbors=k)
   model.fit(merged_DD_keyPreference_X_train, merged_DD_keyPreference_y_train)
   merged_DD_keyPreference_y_pred = model.predict(merged_DD_keyPreference_X_test)
   scores_merged_DD_keyPreference[k] = metrics.accuracy_score(merged_DD_keyPreference_y_test,merged_DD_keyPreference_y_pred)
   scores_merged_DD_keyPreference_list.append(metrics.accuracy_score(merged_DD_keyPreference_y_test,merged_DD_keyPreference_y_pred))
result_merged_DD_keyPreference = metrics.confusion_matrix(merged_DD_keyPreference_y_test, merged_DD_keyPreference_y_pred)
# print("Confusion Matrix:")
# print(result_merged_DD_keyPreference)
result_merged_DD_keyPreference_1 = metrics.classification_report(merged_DD_keyPreference_y_test, merged_DD_keyPreference_y_pred)
# print("Classification Report:",)
# print (result_merged_DD_keyPreference_1)
...
selected_index_merged_DD_keyPreference = np.argmax(scores_merged_DD_keyPreference_list)
selected_k_merged_DD_keyPreference = range(1,30)[selected_index_merged_DD_keyPreference]

knn_merged_DD_keyPreference = KNeighborsClassifier(n_neighbors=selected_k_merged_DD_keyPreference)
knn_merged_DD_keyPreference.fit(merged_DD_keyPreference_X_train, merged_DD_keyPreference_y_train)
merged_DD_keyPreference_y_pred = knn_merged_DD_keyPreference.predict(merged_DD_keyPreference_X_test)

merged_DD_keyPreference_data_accuracy = accuracy_score(merged_DD_keyPreference_y_test, merged_DD_keyPreference_y_pred)
#precision = precision_score(merged_DD_keyPreference_y_test, merged_DD_keyPreference_y_pred, average="micro")
#recall = recall_score(merged_DD_keyPreference_y_test, merged_DD_keyPreference_y_pred, average="micro")
...
merged_UU_keyPreference_X = merged_UU_keyPreference_data.drop(['user','session', 'task', 'iteration'], axis=1)
merged_UU_keyPreference_y= merged_UU_keyPreference_data['user']

merged_UU_keyPreference_X_train, merged_UU_keyPreference_X_test, merged_UU_keyPreference_y_train, merged_UU_keyPreference_y_test = train_test_split(merged_UU_keyPreference_X, merged_UU_keyPreference_y, test_size = 0.4)

scaler_merged_UU_keyPreference = StandardScaler()
scaler_merged_UU_keyPreference.fit(merged_UU_keyPreference_X_train)
merged_UU_keyPreference_X_train = scaler_merged_UU_keyPreference.transform(merged_UU_keyPreference_X_train)
merged_UU_keyPreference_X_test = scaler_merged_UU_keyPreference.transform(merged_UU_keyPreference_X_test)


scores_merged_UU_keyPreference = {}
scores_merged_UU_keyPreference_list = []
for k in range(1,15):
   model = KNeighborsClassifier(n_neighbors=k)
   model.fit(merged_UU_keyPreference_X_train, merged_UU_keyPreference_y_train)
   merged_UU_keyPreference_y_pred = model.predict(merged_UU_keyPreference_X_test)
   scores_merged_UU_keyPreference[k] = metrics.accuracy_score(merged_UU_keyPreference_y_test,merged_UU_keyPreference_y_pred)
   scores_merged_UU_keyPreference_list.append(metrics.accuracy_score(merged_UU_keyPreference_y_test,merged_UU_keyPreference_y_pred))
result_merged_UU_keyPreference = metrics.confusion_matrix(merged_UU_keyPreference_y_test, merged_UU_keyPreference_y_pred)
# print("Confusion Matrix:")
# print(result_merged_UU_keyPreference)
result_merged_UU_keyPreference_1 = metrics.classification_report(merged_UU_keyPreference_y_test, merged_UU_keyPreference_y_pred)
# print("Classification Report:",)
# print (result_merged_UU_keyPreference_1)
...
selected_index_merged_UU_keyPreference = np.argmax(scores_merged_UU_keyPreference_list)
selected_k_merged_UU_keyPreference = range(1,30)[selected_index_merged_UU_keyPreference]

knn_merged_UU_keyPreference = KNeighborsClassifier(n_neighbors=selected_k_merged_UU_keyPreference)
knn_merged_UU_keyPreference.fit(merged_UU_keyPreference_X_train, merged_UU_keyPreference_y_train)
merged_UU_keyPreference_y_pred = knn_merged_UU_keyPreference.predict(merged_UU_keyPreference_X_test)

merged_UU_keyPreference_data_accuracy = accuracy_score(merged_UU_keyPreference_y_test, merged_UU_keyPreference_y_pred)
#precision = precision_score(merged_UU_keyPreference_y_test, merged_UU_keyPreference_y_pred, average="micro")
#recall = recall_score(merged_UU_keyPreference_y_test, merged_UU_keyPreference_y_pred, average="micro")
...
accuracyReport("DU", DU_accuracy, merged_DU_accuracy_data_accuracy, merged_DU_speed_data_accuracy, merged_DU_keyPreference_data_accuracy, merged_DU_reaction_data_accuracy)

accuracyReport("UD", UD_accuracy, merged_UD_accuracy_data_accuracy, merged_UD_speed_data_accuracy, merged_UD_keyPreference_data_accuracy, merged_UD_reaction_data_accuracy)

accuracyReport("UU", UU_accuracy, merged_UU_accuracy_data_accuracy, merged_UU_speed_data_accuracy, merged_UU_keyPreference_data_accuracy, merged_UU_reaction_data_accuracy)

accuracyReport("DD", DD_accuracy, merged_DD_accuracy_data_accuracy, merged_DD_speed_data_accuracy, merged_DD_keyPreference_data_accuracy, merged_DD_reaction_data_accuracy)
