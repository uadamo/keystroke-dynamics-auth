...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2b-single-mlp')
    ...
    ws_stats = wb.add_sheet('task2b-statistical-mlp')
    ...
    ws_non_temp = wb.add_sheet('task2b-non-temporal-mlp')
    ...
    ws_all = wb.add_sheet('task2b-all-mlp')
    ...
    wb.save("task2b_mlp_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task2b-mlp-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 25), featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 32), featureAnalysisSequentialSelector(UU_non_temporal_and_statistic_data, 35)]
    ...
    wb.save("task2b_mlp_sequential.xls")  
...
#     # single features - no selection
#     ws = wb.add_sheet('task2b-mlp-recursive-CV')
...
#     wb.save("task2b_mlp_recursive-CV.xls")  
