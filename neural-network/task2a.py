...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task2a-single-mlp')
    ...
    ws_stats = wb.add_sheet('task2a-statistical-mlp')
    ...
    ws_non_temp = wb.add_sheet('task2a-non-temporal-mlp')
    ...
    ws_all = wb.add_sheet('task2a-all-mlp')
