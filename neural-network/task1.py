...
def xlReportNoSelection():
    ...
    ws_single = wb.add_sheet('task1-single-mlp')
    ...
    ws_stats = wb.add_sheet('task1-statistical-mlp')
    ...
    ws_non_temp = wb.add_sheet('task1-non-temporal-mlp')
    ...
    ws_all = wb.add_sheet('task1-all-mlp')
    ...
    wb.save("task1_mlp_no_selection.xls")  
...
def xlReportSequentialSelection():
    ...
    # single features - no selection
    ws = wb.add_sheet('task1-mlp-sequential')
    ...
    feat = [featureAnalysisSequentialSelector(DD_non_temporal_and_statistic_data, 10)]
    ...
    wb.save("task1_mlp_sequential.xls")  
...
#     # single features - no selection
#     ws = wb.add_sheet('task1-mlp-recursive-CV')
...
#     wb.save("task1_mlp_recursive-CV.xls")  
